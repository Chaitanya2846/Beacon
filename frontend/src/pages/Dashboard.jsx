                ...
                <div className="mt-3 pt-3 border-t border-slate-100/50">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {msg.sources.map((src, sIdx) => (
                      <span key={sIdx} className="bg-white border border-slate-200 shadow-sm text-slate-600 px-2.5 py-1 rounded-md text-[10px] font-medium flex items-center gap-1.5">
                        <svg className="w-3 h-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Doc Snippet {sIdx + 1} 
                        <span className={`font-bold ${src.score > 0.8 ? 'text-emerald-500' : 'text-amber-500'}`}>
